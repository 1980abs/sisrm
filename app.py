...
# --- NOVIDADE: Adiciona a logo que já está no seu GitHub ---
if os.path.exists("logo.png"):
    # Coloquei centralizado para ficar mais bonito
...
# Área para enviar os arquivos
arquivos_enviados = st.file_uploader("Arraste e solte as planilhas aqui", type=['xlsx', 'csv'], accept_multiple_files=True)
